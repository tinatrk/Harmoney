...
enum class Currency(override val id: Long, val code: String, val symbol: String) : IdEnum {
    RUB(id = 1, code = CurrencyStrings.RUB_CODE, symbol = CurrencyStrings.RUB_SYMBOL),
    USD(id = 2, code = CurrencyStrings.USD_CODE, symbol = CurrencyStrings.USD_SYMBOL),
    EUR(id = 3, code = CurrencyStrings.EUR_CODE, symbol = CurrencyStrings.EUR_SYMBOL);
